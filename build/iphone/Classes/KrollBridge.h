...
@interface FontawesomeObject : KrollCoverageObject {
#else
@interface FontawesomeObject : KrollObject {
#endif
@private
...
extern NSString * Fontawesome$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FontawesomeObject *_fontawesome;
    KrollObject* console;
	BOOL shutdown;
