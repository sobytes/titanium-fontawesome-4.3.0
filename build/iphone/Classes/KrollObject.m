...
//@interface FontawesomeObject : NSObject
//@end

@interface FontawesomeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FontawesomeObject class]])
		{
			for (NSString *key in [[(FontawesomeObject*)o modules] allKeys])
			{
