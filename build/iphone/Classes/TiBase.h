...
// in simulator we redefine to format for Fontawesome Developer console
...
{\
	NSString * exceptionName = [@"org.fontawesome." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fontawesome";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFontawesomeNativeItemNone = -1, 
	UIFontawesomeNativeItemSpinner = -2,
	UIFontawesomeNativeItemProgressBar = -3,
	
	UIFontawesomeNativeItemSlider = -4,
	UIFontawesomeNativeItemSwitch = -5,
	UIFontawesomeNativeItemMultiButton = -6,
	UIFontawesomeNativeItemSegmented = -7,
	
	UIFontawesomeNativeItemTextView = -8,
	UIFontawesomeNativeItemTextField = -9,
	UIFontawesomeNativeItemSearchBar = -10,
	
	UIFontawesomeNativeItemPicker = -11,
	UIFontawesomeNativeItemDatePicker = -12,
	
	UIFontawesomeNativeItemInfoLight = -13,
	UIFontawesomeNativeItemInfoDark = -14,
	
	UIFontawesomeNativeItemDisclosure = -15,
	
	UIFontawesomeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Fontawesome instances of
