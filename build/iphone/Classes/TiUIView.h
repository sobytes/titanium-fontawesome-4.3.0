...
/**
 Base class for all Fontawesome views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Fontawesome view hierarchy (such as wrapped iOS UIViews) was touched.
